...
task_priorities_route = Namespace(path="/tasks/priorities", name="Tasks", description="Manage tasks")
...
class TaskPriorities(RequestValidationController):
    ...
    def put(self, **kwargs) -> Response:
        ...
        task_service.change_priority(task=task, priority=params["priority"])
