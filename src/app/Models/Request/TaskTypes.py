...
create_task_type_request = api.model(
...
update_task_type_request = api.model(
...
disable_task_type_request = api.model("Disable Task Type Request", {"id": fields.Integer()})
