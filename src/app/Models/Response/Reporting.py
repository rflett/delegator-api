...
task_time_dto = api.model(
    "Report Time", {"task_type": fields.String, "time_to_start": fields.Integer, "time_to_finish": fields.Integer}
)

slowest_dto = api.model(
    "Report Slowest",
    {
...
completed_dto = api.model(
    "Report Completed", {"finished_by": fields.String, "task_type": fields.String, "finished_at": fields.DateTime}
)

status_dto = api.model(
    "Report Status",
    {
...
delays_dto = api.model("Report Delays", {"task_type": fields.String, "delayed_For": fields.Integer})

get_all_reports_response = api.model(
