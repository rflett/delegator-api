...
task_type_response = api.model("Task Type Response", {
    "id": fields.Integer(),
    "label": fields.String(),
...
task_types_response = api.model("Task Types Response", {
    "task_types": fields.List(fields.Nested(task_type_response))
})
