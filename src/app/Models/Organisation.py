...
class Organisation(db.Model):
    ...
    product_tier = db.Column('product_tier', db.Integer, db.ForeignKey('product_tiers.plan_id'))
    chargebee_customer_id = db.Column('chargebee_customer_id', db.String)
    chargebee_subscription_id = db.Column('chargebee_subscription_id', db.String)
    ...
    def __init__(self, name: str, product_tier: str, chargebee_customer_id: str, chargebee_subscription_id: str):
        self.name = name
